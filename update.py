...
if selected == "Home":
    ...
    youtube_url = "https://www.youtube.com/embed/GCKbsutmHi8?autoplay=1&loop=1&playlist=GCKbsutmHi8"  # Replace VIDEO_ID with your actual video ID
    st.components.v1.html(f"""
    <iframe width="100%" height="315" src="{youtube_url}" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    """, height=315)
    st.write("""
    ...
    if option == "Log Food":
        ...
        if st.button('Show Results'):
            ...
            if bmi < 18.5:
                ...
                st.markdown("**Daily Nutritional Requirements:**")
                st.markdown("**Calories:** ~2500-3000 kcal")
                st.markdown("**Proteins:** ~1.2-1.5 grams per kg of body weight")
                st.markdown("**Fats:** 25-35% of total daily calories")
                st.markdown("**Carbohydrates:** ~55-60% of total daily calories")

                st.markdown("**Recommended Dishes:**")
                st.markdown("- **Breakfast:** Besan chilla with paneer, smoothie with banana and oats.")
                st.markdown("- **Lunch:** Dal (lentils) with brown rice, vegetable curry, and a side of curd.")
                st.markdown("- **Dinner:** Whole wheat chapati with chicken or tofu curry, and a side of mixed vegetables.")
                st.markdown("- **Snacks:** Nuts, yogurt with fruit, or a peanut butter sandwich.")
        
                st.markdown("**Recommended Fruits:**")
                st.markdown("- Bananas, mangoes, avocados, and dates.")
            elif 18.5 <= bmi < 24.9:
                st.markdown("<p style='color: greenyellow;'>You have a normal weight.</p>", unsafe_allow_html=True)
                st.markdown("### Recommendations:")
                st.markdown("**Daily Nutritional Requirements:**")
                st.markdown("**Calories:** ~2000-2500 kcal")
                st.markdown("**Proteins:** ~0.8-1.0 grams per kg of body weight")
                st.markdown("**Fats:** 20-35% of total daily calories")
                st.markdown("**Carbohydrates:** ~45-65% of total daily calories")

                st.markdown("**Recommended Dishes:**")
                st.markdown("- **Breakfast:** Idli with sambar, a fruit, and a cup of tea or coffee.")
                st.markdown("- **Lunch:** Roti with mixed vegetable curry, dal, and a side salad.")
                st.markdown("- **Dinner:** Grilled fish or tofu with quinoa and a steamed vegetable.")
                st.markdown("- **Snacks:** Fresh fruit, nuts, or a small bowl of chaat.")
        
                st.markdown("**Recommended Fruits:**")
                st.markdown("- Apples, oranges, papayas, and berries.")

            elif 25 <= bmi < 29.9:
                st.markdown("<p style='color: darkorange;'>You are classified as overweight.</p>", unsafe_allow_html=True)
                st.markdown("### Recommendations:")
                st.markdown("**Daily Nutritional Requirements:**")
                st.markdown("**Calories:** ~1500-2000 kcal")
                st.markdown("**Proteins:** ~1.0-1.2 grams per kg of body weight")
                st.markdown("**Fats:** 20-30% of total daily calories")
                st.markdown("**Carbohydrates:** ~45-55% of total daily calories")

                st.markdown("**Recommended Dishes:**")
                st.markdown("- **Breakfast:** Oats porridge with a small serving of fruit.")
                st.markdown("- **Lunch:** Whole grain roti with a vegetable stir-fry and a bowl of salad.")
                st.markdown("- **Dinner:** Baked chicken or chickpea curry with a side of sautéed greens.")
                st.markdown("- **Snacks:** Vegetable sticks with hummus or a handful of nuts.")
        
                st.markdown("**Recommended Fruits:**")
                st.markdown("- Pears, kiwi, berries, and pomegranates.")
            else:
                st.markdown("<p style='color: red;'>You are classified as obese.</p>", unsafe_allow_html=True)
                st.markdown("### Recommendations:")
                st.markdown("**Daily Nutritional Requirements:**")
                st.markdown("**Calories:** ~1200-1500 kcal")
                st.markdown("**Proteins:** ~1.2-1.5 grams per kg of body weight")
                st.markdown("**Fats:** 20-25% of total daily calories")
                st.markdown("**Carbohydrates:** ~40-50% of total daily calories")

                st.markdown("**Recommended Dishes:**")
                st.markdown("- **Breakfast:** Smoothie with spinach, cucumber, and a small serving of fruit.")
                st.markdown("- **Lunch:** Mixed vegetable soup with a side of whole grain bread.")
                st.markdown("- **Dinner:** Grilled fish or tofu with a large serving of steamed vegetables and a side salad.")
                st.markdown("- **Snacks:** Fresh fruit or a small portion of nuts.")
        
                st.markdown("**Recommended Fruits:**")
                st.markdown("- Apples, grapefruits, and melons.")
